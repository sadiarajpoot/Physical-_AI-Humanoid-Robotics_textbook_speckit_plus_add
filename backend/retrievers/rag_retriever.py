...
from .retriever import RAGRetriever, load_test_queries, export_query_results
...
def main():
    ...
    try:
        ...
        if args.validation_mode:
            ...
            parser.print_help()
            print("\nExamples:")
            print("  python rag_retriever.py --query 'What is Physical AI?'")
            print("  python rag_retriever.py --query 'humanoid robotics' --top-k 3")
            print("  python rag_retriever.py --query 'introduction' --filter-source-url 'https://example.com/docs/intro'")
            print("  python rag_retriever.py --validation-mode --num-test-queries 10")
